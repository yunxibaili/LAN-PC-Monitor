...
CONFIG_FILE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "node_config.json")

DEFAULT_CONFIG = {
    "tcp_port": 12345,        # TCP 数据传输端口
    ...
    "collectors": {           # 采集项开关（§10.8 / §13 增强点 #30）
...
def load_config() -> dict:
    ...
    if os.path.exists(CONFIG_FILE):
        try:
            ...
            print(f"[node_config] 配置解析失败，使用默认配置: {e}")
