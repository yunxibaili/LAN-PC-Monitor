...
**Note:** The user will handle git commit and PR creation. When ready to finalize, the user runs `/execution/complete-ticket` to transition Jira and update the implementation plan.
