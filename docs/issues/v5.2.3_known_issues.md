...
> **生成**: 2026-08-21（v5.2.3 Final Audit）
...
| 7 | netifaces 无 cp310+ wheel | P2 | v5.3 | netifaces 0.11.0（2021 年停更）PyPI wheel 仅到 cp39；3.10/3.11 每次 CI 需从 sdist 编译（约 40s），3.12+ 全新安装因 distutils 移除无法构建。建议替换为 psutil.net_if_addrs() 或 ifaddr（zeroconf 已依赖）。本机 3.12 未安装 netifaces，走 common/utils 优雅降级。 |
